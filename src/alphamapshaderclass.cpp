...
bool AlphaMapShaderClass::Initialize(ID3D11Device *device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"alphamapVS.hlsl", L"alphamapPS.hlsl");
	if (!result)
	{
		return false;
	}
...
bool AlphaMapShaderClass::InitializeShader(ID3D11Device *device, HWND hwnd, WCHAR *vFname, WCHAR *pFname)
{
	HRESULT result;
	...
	result = D3DX11CompileFromFile(vFname, NULL, NULL, "AlphaMapVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	result = D3DX11CompileFromFile(pFname, NULL, NULL, "AlphaMapPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
...
void AlphaMapShaderClass::RenderShader(ID3D11DeviceContext *dCtx, int indexCount)
{
