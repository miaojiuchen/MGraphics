...
bool BumpMapShaderClass::Initialize(ID3D11Device *device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"bumpmapVS.hlsl", L"bumpmapPS.hlsl");
	if (!result)
	{
		return false;
	}
...
bool BumpMapShaderClass::InitializeShader(ID3D11Device *device, HWND hwnd, WCHAR *vFname, WCHAR *pFname)
{
	HRESULT result;
	...
	result = D3DX11CompileFromFile(vFname, NULL, NULL, "BumpMapVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	result = D3DX11CompileFromFile(pFname, NULL, NULL, "BumpMapPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
...
void BumpMapShaderClass::RenderShader(ID3D11DeviceContext *dCtx, int indexCount)
{
