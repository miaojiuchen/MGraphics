...
bool ClipPlaneShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"clipplaneVS.hlsl", L"clipplanePS.hlsl");
	if (!result)
	{
		return false;
	}
...
bool ClipPlaneShaderClass::Render(
...
bool ClipPlaneShaderClass::SetShaderParameters(
